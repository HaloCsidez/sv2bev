...
# CAM_FRONT
r_cam_front = R.from_quat([0.4998015430569128,
        -0.5030316162024876,
        0.4997798114386805,
        -0.49737083824542755])
matrix = r_cam_front.as_matrix()
print("CAM_FRONT\n", )
euler = r_cam_front.as_euler('zyx',degrees=True)
print(euler)

# CAM_FRONT_RIGHT
r = R.from_quat([0.2060347966337182,
        -0.2026940577919598,
        0.6824507824531167,
        -0.6713610884174485])
matrix = r.as_matrix()
...
# CAM_BACK_LEFT
r = R.from_quat([0.6924185592174665,
        -0.7031619420114925,
        -0.11648342771943819,
        0.11203317912370753])
matrix = r.as_matrix()
